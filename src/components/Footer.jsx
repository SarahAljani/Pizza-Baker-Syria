  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto flex flex-col items-center justify-center text-center">
        ...
        {/* Navigation Links */}
        <div className={`flex flex-wrap items-center justify-center gap-x-6 gap-y-3 mb-8 text-[11px] font-mono tracking-[0.2em] font-bold text-text-primary ${isRtl ? 'flex-row-reverse' : ''}`}>
